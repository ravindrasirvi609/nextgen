        ...
        <div class="auto-layout">
          <div class="header">
            ...
            <div class="invoice-details">
              ...
              <div class="invoice-number-parent">
                <div class="invoice-number">${transactionData.paymentId}</div>
          ...
          <div class="client">
            <div class="contact">
              ...
              <div class="bill-to8">
                Phone: [enter phone number], Email: ${userData.email}
              </div>
            </div>
            <div class="total-due">
              <div class="total-due-title">Total Amount:</div>
              <div class="total-due-title1">₹${transactionData.amount}</div>
            </div>
          </div>
            ...
            <div class="item">
              <div class="deliverables1">
                <div class="title-description">
                  <div class="title1">Basic Subscription Plan</div>
              ...
              <div class="charges2">
                <div class="quantity3">₹${transactionData.amount}</div>
              </div>
            </div>
            <div class="item">
              <div class="deliverables1">
